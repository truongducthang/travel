...
const ListTag = [
  { id: 1, text: 'Hot', color: '#f50' },
  { id: 2, text: 'New', color: 'cyan' },
  { id: 3, text: '59%', color: '#2db7f5' },
];
const ProductItem = () => {
  ...
  return (
    ...
    >
      ...
      <div className="product_item__action">
        ...
        <div className="product_item__button btn_wishlist">
          <Button
            style={{
              backgroundColor: '#23232c',
              color: '#fff',
        ...
        <div className="product_item__button  btn_detail">
          <Button
            style={{
              backgroundColor: '#23232c',
              color: '#fff',
